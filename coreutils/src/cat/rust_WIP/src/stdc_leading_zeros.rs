...
pub fn stdc_leading_zeros_uc(n: u8) -> u32 {
    ...
    let size_difference = (std::mem::size_of::<u32>() as u64)
        .wrapping_sub(std::mem::size_of::<u8>() as u64);
    (leading_zeros as u64).wrapping_sub(8 * size_difference) as u32
}
...
pub fn stdc_leading_zeros_us(n: u16) -> u32 {
    let leading_zeros = stdc_leading_zeros_ui(n as u32);
    let size_difference = (std::mem::size_of::<u32>() as u64)
        .wrapping_sub(std::mem::size_of::<u16>() as u64);
    (leading_zeros as u64).wrapping_sub(8u64.wrapping_mul(size_difference)) as u32
}
